...
public class TesteDoAvaliador {
	...
	public void deveEntenderLancesEmOrdemCrescente() {
		...
		// parte 3: validacao
		assertEquals(400.0, leiloeiro.getMaiorLance(), 0.00001); //0.00001 -> delta para resolver problemas de arredondamento double
	...
	@Test
	public void deveEncontratOsTresMaioresLances() {
		Usuario joao = new Usuario("João");
		Usuario maria = new Usuario("Maria");
